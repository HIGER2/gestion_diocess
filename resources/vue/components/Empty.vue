<template>
    <div  class="w-full min-h-[200px] flex flex-col gap-1 items-center justify-center">
            <span>Aucun élément</span>
            <svg xmlns="http://www.w3.org/2000/svg" fill="current" height="30" id="Layer_1" data-name="Layer 1" viewBox="0 0 24 24">
