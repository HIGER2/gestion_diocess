                ...
                <div class="content">
                    ...
                    <form action="" @submit.prevent="authLogin">
                        <div class="groupeForm">
                            ...
                            <div class="forminput">
                                <input type="text" v-model="login.username"  class="block w-full rounded-lg border border-gray-300 bg-gray-50 p-3 text-[13px] shadow-sm focus:outline-none focus:ring-1 focus:ring-primary " required>
                            </div>
                        </div>
